$(document).ready(function () {
    ...
    $("#rptTranferCall").css({ 'font-weight': 'bold' });
    ...
    $('button.btn-rpt-ok').click(function (event) {
        $.ajax({
            ...
            success: function (data) {
                var host = data["host"];
                var reporten = "__report=report/TransferredDetails.rptdesign";
                var reportth = "__report=report/TransferredDetailsth.rptdesign";
