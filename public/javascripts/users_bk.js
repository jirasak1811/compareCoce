    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                let tmp = '';
                tmp+="<tr class='showmoredetail' , data-ext='" + data[i].extension + "' , data-username='"+data[i].username+"'>"
                ...
                tmp += "<td align='center'> <a class='edittable-selectActive'<a href='#',data-type='select', data-name='is_active',data-pk='" + data[i].username + "',data-title='Enter Active',data-i18n='[data-title]Enter Active', data-value='" + data[i].is_active + "' >" + (data[i].is_active == '1' ? 'Active' : 'InActive') + " </a></td> "
