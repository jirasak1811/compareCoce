...
$(document).ready(function () {
    $(document).on('click', '.btn-delete-extension', function () {
        ...
        var confirmtxt = ''
        if (Cookies('lang') == 'th') {
            confirmtxt = "ต้องการลบ : " + $(this).attr('data-extension') + "หรือไม่"
        } else {
            confirmtxt = "Do you want to delete : " + $(this).attr('data-extension') + "?"
        }
	...
	var email = $(this).attr('data-email')
        ...
        $.getJSON('/api/v1/extensions/info/' + extension, { user: Cookies('user') }).done(function (data) {
            ...
            if (data.length == 1) {
                ...
                $('#view-detail-body').append("<div class='row col-md-12'><div class='row col-md-6'><div class='row col-md-6'><b data-i18n='name'>Name(Eng) </b></div><div class='row col-md-6'>" + (data[0].name || "") + "</div></div><div style='display:none;' class='row col-md-6'><div class='row col-md-6'><b data-i18n='name'>Name(Eng)</b></div><div class='row col-md-6'>" + (data[0].name || "") + "</div></div></div>")
                ...
                $('#view-detail-body').append("<div class='row col-md-12'><div class='row col-md-2'><b data-i18n='groups'>Groups </b></div>" + ( data[0].org_name || "") + "</div>")
...
function RenderExtensionTable(data) {
    ...
    $.each(Object.keys(data[0]), function (i, d) {
        ...
        // else if(d == 'org_path'){
        //     tmp += "        <th style='display:none' data-i18n='" + d + "'>" + d.charAt(0).toUpperCase() + d.slice(1) + "</th>"
        // }
        else{
            tmp += "        <th data-i18n='" + d + "'>" + d.charAt(0).toUpperCase() + d.slice(1) + "</th>"
        }
    ...
    $.each(data, function (i, d) {
        tmp =''
        tmp += "    <tr editindex='-' class='showmoredetail INL" + d.extension + "' data-extension='" + d.extension + "' data-pk='" + d.extension + "," + d.emp_id + "," + d.name +"' data-email='" + d.email + "' data-name='"+d.name+"'>"
        $.each(Object.keys(data[0]), function (i, keyname) {
            if (d[keyname.toString()] == null || d[keyname.toString()] == "null") {
                d[keyname.toString()] = '-'
            }

            if (keyname.toString() == 'org_name'|| keyname.toString() == 'org_path') {
                tmp += "<td> <a class='INL" + d.extension + "'" + 'data-type="text" editindex="' + (editindex++) + '" data-extension="'+d.extension+'" data-pk="' + d.id +'" data-name="' + keyname.toString() + '" data-emp_id="' + d.emp_id + '" data-namepk="' + d.name + '" data-title="Enter ' + keyname.toString() + '" >' + (d[keyname.toString()] || '-') + "</a></td>"
            }
            // else if (keyname.toString() == 'org_path' ) {
            //     tmp += "<td style='display:none;'> <a class='INL" + d.extension + "'" + 'data-type="text" editindex="' + (editindex++) + '" data-extension="'+d.extension+'" data-pk="' + d.id +'" data-name="' + keyname.toString() + '" data-emp_id="' + d.emp_id + '" data-namepk="' + d.name + '" data-title="Enter ' + keyname.toString() + '" >' + (d[keyname.toString()] || '-') + "</a></td>"
            // }
             else if (keyname.toString() == 'has_license') {
                tmp += "<td> <a class='editable-selectActive INL" + d.extension + "'" + 'data-value="' + d[keyname.toString()] + '" data-type="select" editindex="' + (editindex++) + '" data-extension="' + d.extension +'" data-pk="' + d.id +'" data-name="' + keyname.toString() + '" data-emp_id="' + d.emp_id + '" data-namepk="' + d.name + '" data-title="Enter ' + keyname.toString() + '" >' + (d[keyname.toString()] == '1' ? 'Active' : 'InActive') + "</a></td>"
            } else if (keyname.toString() == 'exttype') {
                tmp += "<td> <a class='editable-selectexttype INL" + d.extension + "'" + 'data-type="select" editindex="' + (editindex++) + '" data-extension="' + d.extension + '" data-pk="' + d.id +'" data-name="' + keyname.toString() + '" data-emp_id="' + d.emp_id + '" data-namepk="' + d.name + '"  data-title="Enter ' + keyname.toString() + '" >' + (d[keyname.toString()] || '-') + "</a></td>"
            } else if (keyname.toString() == 'emp_id' || keyname.toString() == 'id') {

            } else if (keyname.toString() == 'rent_charge' || keyname.toString() == 'special_service_fee') {
                tmp += "<td> <a class='editable INL" + d.extension + "'" + 'data-type="text" editindex="' + (editindex++) + '" data-extension="' + d.extension +'" data-pk="' + d.id +'" data-name="' + keyname.toString() + '"data-emp_id="' + d.emp_id + '" data-namepk="' + d.name + '" data-title="Enter ' + keyname.toString() + '" >' + d[keyname.toString()] + "</a></td>"
            }
            else {
                tmp += "<td> <a class='editable INL" + d.extension + "'" + ' style="word-break:break-all;" data-type="text" editindex="' + (editindex++) + '" data-extension="' + d.extension +'" data-pk="' + d.id +'" data-name="' + keyname.toString() + '" data-emp_id="' + d.emp_id + '" data-namepk="' + d.name + '" data-title="Enter ' + keyname.toString() + '" >' + (d[keyname.toString()] || '-') + "</a></td>"
            }
        });
        //Action 
        tmp += "<td align='center' style='text-align:center;width:30px'> <a class='btn btn-warning btn-xs btn-delete-extension INL" + d.extension + "' editindex='-'  data-pk='" + d.id + "' data-namepk='" + d.name + "' data-emp_id='" + d.emp_id + "' data-extension='" + d.extension +"'><i class='fa fa-trash'></i></a></td>"
        tmp += "</tr>"
