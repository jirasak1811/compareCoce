$(document).ready(function () {
    ...
    $("#rptDialledSummary").css({ 'font-weight': 'bold' });
    ...
    $('button.btn-rpt-ok').click(function (event) {
        $.ajax({
            ...
            success: function (data) {
                var host = data["host"];
                var reporten = "__report=report/DialledNumberSummary.rptdesign";
                var reportth = "__report=report/DialledNumberSummaryth.rptdesign";
