    ...
    $('.showmoredetail').on('click', function () {
        if ($('.directory-list').attr('data-role') != 'user' && $('.directory-list').attr('data-role') != 'guest') {
            ...
            $.getJSON('/api/v1/directorysearch/search/' + $('.directory-list').attr('data-role') + '/detail/' + $(this).attr('data-key'), { user: user }).done(function (data) {
                ...
                $('#headerlist').html('')
                $('#headerlist').append("<div class='row col-md-12'><div class='row col-md-6'><div class='row col-md-6'><b data-i18n='extension'>extension </b></div><div class='row col-md-6'>" + (data[0].extension || '') + "</div></div><div class='row col-md-6'><div style='display:none;' class='row col-md-6'><b data-i18n='nameth'>nameth</b></div><div class='row col-md-6'>" + ( data[0].nameth || '') + "</div></div></div>")
                $('#headerlist').append("<div class='row col-md-12'><div class='row col-md-6'><div class='row col-md-6'><b data-i18n='name'>name</b></div><div class='row col-md-6'>" + ( data[0].name || '' )  + "</div></div></div>")
                ...
                $('#headerlist').append("<div class='row col-md-12'><div class='row col-md-2'><b data-i18n='groups'>Groups </b></div>" + (data[0].org_name || "") + "</div>")
            ...
            $.getJSON('/api/v1/directorysearch/search/' + $('.directory-list').attr('data-role') + '/detail/' + $(this).attr('data-key'), { user: user }).done(function (data) {
                console.log(data)
                $('#headerlist').html('')
                $('#headerlist').append("<div class='row col-md-12'><div class='row col-md-6'><div class='row col-md-6'><b data-i18n='extension'>extension </b></div><div class='row col-md-6'>" + (data[0].extension || '') + "</div></div></div>")
