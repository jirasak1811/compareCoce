...
function getChartData() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            var ChartData = []
            for (var i = 0; i < data.length; i++) {
                if (ChartData[parseInt(moment(data[i].startTime, 'YYYY-MM-DD HH:mm:ss').format('HH'))] == undefined) {
                    ChartData[parseInt(moment(data[i].startTime, 'YYYY-MM-DD HH:mm:ss').format('HH'))] = { In: 0, Out: 0 }
                    if (data[i].callType == 'IN') {
                        ChartData[parseInt(moment(data[i].startTime, 'YYYY-MM-DD HH:mm:ss').format('HH'))].In++
                    } else if (data[i].callType == 'OUT') {
                        ChartData[parseInt(moment(data[i].startTime, 'YYYY-MM-DD HH:mm:ss').format('HH'))].Out++
                    } else {
                        ////console.log(data[i])
                    }
                } else {
            ...
            for (var i = 0; i < ChartData.length; i++) {
                if (ChartData[Object.keys(ChartData)[i]] != undefined) {
                    mapChart.push({ y: Object.keys(ChartData)[i], a: ChartData[Object.keys(ChartData)[i]].In, b: ChartData[Object.keys(ChartData)[i]].Out })
                }
            }
