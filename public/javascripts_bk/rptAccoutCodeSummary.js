$(document).ready(function () {
    ...
    $("#rptAccoutCodeSummary").css({ 'font-weight': 'bold' });
    ...
    $('button.btn-rpt-ok').click(function (event) {
        $.ajax({
            ...
            success: function (data) {
                var host = data["host"];
                var reporten = "__report=report/AccountCodeSummary.rptdesign";
                var reportth = "__report=report/AccountCodeSummaryth.rptdesign";
