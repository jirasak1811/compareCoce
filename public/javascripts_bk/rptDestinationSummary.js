$(document).ready(function () {
    ...
    $("#rptDestinationSummary").css({ 'font-weight': 'bold' });
    ...
    $('button.btn-rpt-ok').click(function (event) {
        ...
        $.ajax({
            ...
            success: function (data) {
                var host = data["host"];
                var reporten = "__report=report/DestinationSummary.rptdesign";
                var reportth = "__report=report/DestinationSummaryth.rptdesign";
