$(document).ready(function () {
    ...
    $("#rptMonthlyChargeSummary").css({ 'font-weight': 'bold' });
    ...
    $('button.btn-rpt-ok').click(function (event) {
        $.ajax({
            ...
            success: function (data) {
                var host = data["host"];
                var reporten = "__report=report/MonthlyChargeSummary.rptdesign";
                var reporteh = "__report=report/MonthlyChargeSummaryth.rptdesign";
