...
router.get('/', function (req, res, next) {
  res.render('v1/b2e/report', { title: 'Report', login_name: req.signedCookies.login_name });
});

router.get('/new', function (req, res, next) {
  if (req.signedCookies.login_type == "Admin" && (req.signedCookies.login_name) && (req.signedCookies.login_extension)) {
    ...
    res.render('v1/b2e/login', { title: 'login' });
  }
});
