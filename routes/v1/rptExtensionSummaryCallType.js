$(document).ready(function () {
    ...
    $("#rptExtensionSummaryCallType").css({ 'font-weight': 'bold' });
    ...
    $('button.btn-rpt-ok').click(function (event) {
        $.ajax({
            ...
            success: function (data) {
                var host = data["host"];
                var reporten = "__report=report/ExtensionSummaryCallType.rptdesign";
                var reportth = "__report=report/ExtensionSummaryCallType.rptdesign";
